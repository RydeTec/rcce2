...
pub use feedback::{
    ...
    FeedbackActorCatalog, FeedbackActorCount, FeedbackActorMesh, FeedbackActorReference,
    FeedbackAssetCatalog, FeedbackAssetPathCatalog, FeedbackAssetPathFacet, FeedbackDiagnostic,

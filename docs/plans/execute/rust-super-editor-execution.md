...
1. Continue M1-P06 with the bounded Slint one-device/shared-wgpu seam; reference fixture, machine, and memory-budget approvals remain blocked.
2. Select the next dependency-ready M1 packet without broadening P05 into additional reference families.

...
1. Run M1-P06 architecture review without silently adding a second GPU owner, migrating `rcce-render`, forking a framework renderer, or waiving accessibility/performance gates.

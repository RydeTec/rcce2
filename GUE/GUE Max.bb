...
If (GUE_width < 1920 And GUE_height< 1080)
	GUE_width = 1920
	GUE_height = 1080
EndIf
WriteLog(GUELog, "Initialising windowed graphics mode")
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Creating media dialogs", True : Flip() 
InitMediaDialogs()

; Interface
WriteLog(GUELog, "Loading game interface settings")
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Loaded game interface settings", True : Flip()
ClearTextureFilters()
...
; All emitter configs
WriteLog(GUELog, "Loading emitter configurations")
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Loading emitter configurations", True : Flip()
DefaultTex = LoadTexture("Data\DefaultParticle.bmp", 4 + 16 + 32)
D = ReadDir("Data\Emitter Configs")
 File$ = NextFile$(D)
 While File$ <> ""
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Loaded damage types", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Loaded attributes", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Loaded factions", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Loaded animations", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Loaded projectiles", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Loaded items", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Loaded actors", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Loaded abilities", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Loaded zones", True : Flip()
Global TotalZones = 0
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created GUI", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created project tab", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created media tab", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created particles tab", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created combat tab", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created projectiles tab", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created factions tab", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created animations tab", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created attributes tab", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created actors tab", True : Flip()
...
TabActors = FUI_Tab(TActors, 20, 100, GUE_width - 224, 543)
...
FUI_Label(TActorsGeneral, 1000, 22, "Attributes:", ALIGN_CENTER)
Global LActorAttributes = FUI_ListBox(TActorsGeneral, 900, 50, 200, 450)
For i = 0 To 39
	If AttributeNames$(i) <> ""
		Item = FUI_ListBoxItem(LActorAttributes, AttributeNames$(i)) : FUI_SendMessage(Item, M_SETDATA, i)
	EndIf
Next
FUI_Label(TActorsGeneral, 1140, 22, "Attribute value:")
Global SActorAttribute = FUI_Spinner(TActorsGeneral, 1140, 50, 100, 20, 0, 65535, 0, 1, DTYPE_INTEGER)
FUI_Label(TActorsGeneral, 1140, 102, "Attribute maximum:")
Global SActorAttributeMax = FUI_Spinner(TActorsGeneral, 1140, 130, 100, 20, 0, 65535, 0, 1, DTYPE_INTEGER)
FUI_Label(TActorsGeneral, 1420, 22, "Resistances:", ALIGN_CENTER)
Global LActorResistances = FUI_ListBox(TActorsGeneral, 1320, 50, 200, 450)
For i = 0 To 19
	If DamageTypes$(i) <> ""
		Item = FUI_ListBoxItem(LActorResistances, DamageTypes$(i)) : FUI_SendMessage(Item, M_SETDATA, i)
	EndIf
Next
FUI_Label(TActorsGeneral, 1560, 22, "Resistance value:")
Global SActorResistance = FUI_Spinner(TActorsGeneral, 1560, 50, 100, 20, 0, 65535, 0, 1, DTYPE_INTEGER)

; Preview
;VActorPreview = FUI_View(TActorsPreview, 146, 30, 640, 480, 0, 0, 0)
VActorPreview = FUI_View(TActorsAppearance, 1000, 20, 640, 480, 0, 0, 0)
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created items tab", True : Flip()
...
TabItems = FUI_Tab(TItems, 20, 100, GUE_width - 224, 543)
...
;------------------------------------------------------
Global LItemWeaponDamage = FUI_Label(TItemsGeneral, 520, 22, "Damage:")
Global SItemWeaponDamage = FUI_Spinner(TItemsGeneral, 610, 20, 50, 20, 1, 5000, 0, 1, DTYPE_INTEGER)
Global LItemWeaponType = FUI_Label(TItemsGeneral, 520, 52, "Weapon type:")
Global CItemWeaponType = FUI_ComboBox(TItemsGeneral, 610, 50, 100, 20)
FUI_ComboBoxItem(CItemWeaponType, "One Handed")
FUI_ComboBoxItem(CItemWeaponType, "Two Handed")
FUI_ComboBoxItem(CItemWeaponType, "Ranged")
Global LItemDamageType = FUI_Label(TItemsGeneral, 520, 82, "Damage type:")
Global CItemDamageType = FUI_ComboBox(TItemsGeneral, 610, 80, 200, 20, 6)
For i = 0 To 19
	If DamageTypes$(i) <> ""
		Item = FUI_ComboBoxItem(CItemDamageType, DamageTypes$(i))
		FUI_SendMessage(Item, M_SETDATA, i)
	EndIf
Next
Global LItemRangedProjectile = FUI_Label(TItemsGeneral, 520, 112, "Projectile:")
Global CItemRangedProjectile = FUI_ComboBox(TItemsGeneral, 610, 110, 200, 20, 10)
For P.Projectile = Each Projectile
	Item = FUI_ComboBoxItem(CItemRangedProjectile, P\Name$)
	FUI_SendMessage(Item, M_SETDATA, P\ID)
Next
Global LItemRangedAnimation = FUI_Label(TItemsGeneral, 520, 142, "Ranged animation:")
Global TItemRangedAnimation = FUI_TextBox(TItemsGeneral, 610, 140, 100, 20)
Global LItemRange = FUI_Label(TItemsGeneral, 520, 172, "Maximum range:")
Global SItemRange = FUI_Spinner(TItemsGeneral, 610, 170, 80, 20, 0.1, 200.0, 0.0, 0.1, DTYPE_FLOAT)
Global LItemArmourLevel = FUI_Label(TItemsGeneral, 520, 22, "Armour level:")
Global SItemArmourLevel = FUI_Spinner(TItemsGeneral, 600, 20, 100, 20, 0, 5000, 0, 1, DTYPE_INTEGER)
Global LItemEatEffects = FUI_Label(TItemsGeneral, 520, 22, "Effects duration:")
Global SItemEatEffects = FUI_Spinner(TItemsGeneral, 610, 20, 100, 20, 1, 100000, 0, 1, DTYPE_INTEGER, " seconds")
Global LItemImageID = FUI_Label(TItemsGeneral, 520, 22, "Display image: [NONE]")
Global BItemImageID = FUI_Button(TItemsGeneral, 520, 45, 90, 20, "Change")
Global LItemMiscData = FUI_Label(TItemsGeneral, 520, 22, "Miscellaneous data:")
Global TItemMiscData = FUI_TextBox(TItemsGeneral, 625, 20, 300, 20)
...
Global BItemStackable = FUI_CheckBox(TItemsGeneral, 900, 20, "Item can be stacked")
Global BItemTakesDamage = FUI_CheckBox(TItemsGeneral, 900, 50, "Item takes damage")
FUI_Label(TItemsGeneral, 900, 102, "Item is exclusive to this race:")
Global CItemExclusiveRace = FUI_ComboBox(TItemsGeneral, 1130, 100, 350, 20, 10)
FUI_ComboBoxItem(CItemExclusiveRace, "None (can be used by any race)")
FUI_Label(TItemsGeneral, 900, 132, "Item is exclusive to this class:")
Global CItemExclusiveClass = FUI_ComboBox(TItemsGeneral, 1130, 130, 350, 20, 10)
FUI_ComboBoxItem(CItemExclusiveClass, "None (can be used by any class)")
FUI_Label(TItemsGeneral, 900, 182, "Item runs this script on right-click:")

Global CItemScript = FUI_ComboBox(TItemsGeneral, 1130, 180, 350, 20, 10)
FUI_ToolTip(CItemScript, "Tip: Scripts must start with  Item_  to be seen here.")

FUI_ComboBoxItem(CItemScript, "None")
FUI_Label(TItemsGeneral, 900, 212, "Function to start script in:")
Global CItemMethod = FUI_ComboBox(TItemsGeneral, 1130, 210, 350, 20, 10)
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created seasons tab", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created zones tab", True : Flip()
...
BZoneUndo   = FUI_Button(TZones, 410, 20, 20, 20, "", "Data\GUE\L.png") : FUI_ToolTip(BZoneUndo, "Undo, Ctrl + Z")
Global BZoneScenery   = FUI_Button(TZones, 460, 20, 20, 20, "", "Data\GUE\612-home.png", 1) : FUI_ToolTip(BZoneScenery, "Scenery Mode")
Global BZoneTerrain   = FUI_Button(TZones, 485, 20, 20, 20, "", "Data\GUE\128-status.png", 1) : FUI_ToolTip(BZoneTerrain, "Terrain Mode")
Global BZoneEmitters  = FUI_Button(TZones, 510, 20, 20, 20, "", "Data\GUE\212-thunderbolt.png", 1) : FUI_ToolTip(BZoneEmitters, "Emitters Mode")
Global BZoneWater     = FUI_Button(TZones, 535, 20, 20, 20, "", "Data\GUE\608-funnel.png", 1) : FUI_ToolTip(BZoneWater, "Water Mode")
Global BZoneColBox    = FUI_Button(TZones, 560, 20, 20, 20, "", "Data\GUE\614-lock.png", 1) : FUI_ToolTip(BZoneColBox, "Collision box Mode")
Global BZoneSoundZone = FUI_Button(TZones, 585, 20, 20, 20, "", "Data\GUE\084-music.png", 1) : FUI_ToolTip(BZoneSoundZone, "Sound zone Mode")
Global BZoneTriggers  = FUI_Button(TZones, 610, 20, 20, 20, "", "Data\GUE\609-gift.png", 1) : FUI_ToolTip(BZoneTriggers, "Trigger Mode")
Global BZoneWaypoints = FUI_Button(TZones, 635, 20, 20, 20, "", "Data\GUE\409-left_right.png", 1) : FUI_ToolTip(BZoneWaypoints, "Waypoint Mode")
Global BZonePortals   = FUI_Button(TZones, 660, 20, 20, 20, "", "Data\GUE\029-app.png", 1) : FUI_ToolTip(BZonePortals, "Portal Mode")
Global BZoneEnviro    = FUI_Button(TZones, 685, 20, 20, 20, "", "Data\GUE\089-star.png", 1) : FUI_ToolTip(BZoneEnviro, "Environment Options")
Global BZoneOther     = FUI_Button(TZones, 710, 20, 20, 20, "", "Data\GUE\103-options2.png", 1) : FUI_ToolTip(BZoneOther, "Other Options")
Global BZoneLights    = FUI_Button(TZones, 735, 20, 20, 20, "", "Data\GUE\001-light.png", 1) : FUI_ToolTip(BZoneLights, "Dynamic Lights")


;FUI_Label(TZones, 720, 22, "Current zone:")
;Global CZone = FUI_ComboBox(TZones, 800, 20, 160, 20, 10)
FUI_Label(TZones, GUE_width - 304, 22, "Current zone:")
Global CZone = FUI_ComboBox(TZones, GUE_width - 224, 20, 210, 20, 10)
...
; Mode buttons
Global BZoneSelect = FUI_Button(TZones, 840, 20, 100, 20, "Select", 0, 2) : FUI_ToolTip(BZoneSelect, "Select, F1")
Global BZoneMove   = FUI_Button(TZones, 950, 20, 100, 20, "Move", 0, 2) : FUI_ToolTip(BZoneMove, "Move, F2")
Global BZoneRotate = FUI_Button(TZones, 1060, 20, 100, 20, "Rotate", 0, 2) : FUI_ToolTip(BZoneRotate, "Rotate, F3")
Global BZoneScale  = FUI_Button(TZones, 1170, 20, 100, 20, "Scale", 0, 2) : FUI_ToolTip(BZoneScale, "Scale, F4")
FUI_SendMessage(BZoneSelect, M_SETSELECTED, True)
BZonePrecise = FUI_Button(TZones, 1280, 20, 100, 20, "Precise")
...
;NEW
FUI_Label(TZones, 1420, 22, "Camera speed:")
SCameraSpeed = FUI_Spinner(TZones, 1500, 20, 70, 20, 1, 100, 20, 1, DTYPE_INTEGER, "%")
...
;Dynamic Lights
Global GDynamicC = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Dynamic Light Placement")
...
Global GScenery = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Scenery placement")
...
Global GSceneryOptions = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Scenery options")
...
Global GTerrain = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Terrain placement")
...
Global GTerrainOptions = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Terrain options")
...
Global GEmitters = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Emitter placement")

	Global LEmitter = FUI_ListBox(GEmitters, 5, 10, 195, 915)
	For C.RP_EmitterConfig = Each RP_EmitterConfig
...
Global GEmitterOptions = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Emitter options")
...
Global GWater = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Water placement")
...
Global GWaterOptions = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Water options")
...
Global GSound = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Sound zone placement")
...
Global GSoundOptions = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Sound zone options")
...
Global GTrigger = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Trigger placement")
...
Global GTriggerOptions = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Selected trigger")
...
Global GWaypoint = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Waypoint placement")
...
Global GWaypointOptions = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Waypoint options")
...
Global GPortal = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Portal placement")
...
Global GPortalOptions = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Selected portal")
...
Global GEnviroOptions = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Environment options")

	TabEnviroOptions = FUI_Tab(GEnviroOptions, 5, 5, 195, 925)
...
Global GOtherOptions = FUI_GroupBox(TZones, GUE_width - 224, 47, 210, 950, "Other options")
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created abilities tab", True : Flip()
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Created interface tab", True : Flip()

BInterfaceSave = FUI_Button(TInterface, 1300, 20, 130, 20, "Save interface layout")
VInterface = FUI_View(TInterface, 10, 20, 1280, 960, 0, 0, 0)
FUI_Label(TInterface, 1500, 52, "Interface components")
Global RInterfaceMain = FUI_Radio(TInterface, 1300, 70, "Game screen", True, 1)
Global RInterfaceInventory = FUI_Radio(TInterface, 1300, 100, "Inventory", False, 1)
...
Global LInterfaceComponents = FUI_ListBox(TInterface, 1500, 70, 200, 600)
G = FUI_GroupBox(TInterface, 1300, 700, 500, 150, "Component settings")
...
FUI_Label(TInterface, 1300, 510, "Chat text area background:");, ALIGN_CENTER)
LInterfaceChatTex = FUI_Label(TInterface, 1370, 540, EditorTexName$(Chat\Texture), ALIGN_CENTER)
BInterfaceChatTex = FUI_Button(TInterface, 1320, 570, 90, 20, "Change")
BInterfaceChatTexN = FUI_Button(TInterface, 1320, 600, 90, 20, "None")
...
Color 255, 255, 255 : DrawImage(Img, 0, 0) : Text (ImageWidth(Img)/2), 551, "Initialising gadgets-Launching", True : Flip()

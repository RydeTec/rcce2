...
Function FUI_Window( X, Y, W, H, Caption$="Window", Icon$=0, Flags=WS_TITLEBAR Or WS_ALLBUTTONS, Buttons=0 ) ;[001]
...
Function FUI_Initialise( W, H, D, M, Resizable=False, Border=True, Caption$="", Version$="" )
 ...
 ;###########################################################################
; Edited by clan_fd Mar 12, 2014
; Helps sharpen GUE text
;MoveEntity (App\Cam, 0, 0, -10000)
...
;#######################################################
; Edited by clan_fd Mar 12, 2014
; Helps fix some problems due to editing MoveEntity parameters above
...
;############################################################ [001]
; Edited by clan_fd Mar 12, 2014
; Change GUI color from red to blue

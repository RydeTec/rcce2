...
CustomPostprocessGrayscale_% (alpha#, brightness#, fmethod%, alphaTexture%) : "CustomPostprocessGrayscale_"
CustomPostprocessContrast_% (alpha#, fmethod%, red%, green%, blue%, alphaTexture%) : "CustomPostprocessContrast_"

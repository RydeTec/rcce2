...
Test testLoomGuidanceDocumentsEveryShippedBrowserCategory()
	...
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "actor" + Quote$ + ",   " + Quote$ + "Actors" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "item" + Quote$ + ",    " + Quote$ + "Items" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "spell" + Quote$ + ",   " + Quote$ + "Spells" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "projectile" + Quote$ + ", " + Quote$ + "Projectiles" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "particle" + Quote$ + ", " + Quote$ + "Particles" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "zone" + Quote$ + ",    " + Quote$ + "Zones" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "faction" + Quote$ + ", " + Quote$ + "Factions" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "animset" + Quote$ + ", " + Quote$ + "Animation Sets" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "tools" + Quote$ + ",   " + Quote$ + "Tools" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "script" + Quote$ + ",  " + Quote$ + "Scripts" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "texture" + Quote$ + ", " + Quote$ + "Textures" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "mesh" + Quote$ + ",    " + Quote$ + "Meshes" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "sound" + Quote$ + ",   " + Quote$ + "Sounds" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "music" + Quote$ + ",   " + Quote$ + "Music" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "stats" + Quote$ + ",   " + Quote$ + "Stats" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "environment" + Quote$ + ", " + Quote$ + "Days & Seasons" + Quote$ + ")") = True)
	Assert(FileContains%("Modules\\Loom\\Browser.bb", "Browser::addCategory(self, " + Quote$ + "interface" + Quote$ + ", " + Quote$ + "Interface" + Quote$ + ")") = True)
